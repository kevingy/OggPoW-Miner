...
{
    static const char* name() { return EthGreen " mining"; }
...
int main(int argc, char** argv)
{
    ...
    cout << endl
         << endl
         << "Oggminer " << bi->project_version << endl
         << "Build: " << bi->system_name << "/" << bi->build_type << "/" << bi->compiler_id << endl
         << endl;

    cout << "   ============================================================" << endl
         << "      * Welcome Ogg. You are in the right place. *" << endl
         << "   ============================================================" << endl
         << endl
         << "   You enter cave now. Tribe see you. Ogg nod slowly." << endl
         << endl
         << "   [~] Initializing OggMiner systems..." << endl
         << "   [~] Loading ProgPoW kernel...    Spark appear." << endl
         << "   [~] Warming up the GPU Fire ..." << endl
         << endl
         << "   \"Rock turns into digital copper.\"" << endl
         << "    - Ancient Ogg Proverb" << endl
         << endl;
